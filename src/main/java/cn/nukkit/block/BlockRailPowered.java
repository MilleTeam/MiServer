...
/**
 * Created by Snake1999 on 2016/1/11. Contributed by: larryTheCoder on 2017/7/18.
 * <p>
 * Nukkit Project, Minecart and Riding Project, Package cn.nukkit.block in project Nukkit.
 */
public class BlockRailPowered extends BlockRail
{
	...
	protected boolean canPowered(
		Vector3 pos,
		Rail.Orientation state,
		int power,
		boolean relative
	)
	{
