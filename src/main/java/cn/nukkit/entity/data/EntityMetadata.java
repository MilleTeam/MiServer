...
public class EntityMetadata
{
	...
	public EntityData getOrDefault(
		int id,
		EntityData defaultValue
	)
	{
		try
		{
	...
	public EntityMetadata putShort(
		int id,
		int value
	)
	{
	...
	public EntityMetadata putFloat(
		int id,
		float value
	)
	{
	...
	public EntityMetadata putBoolean(
		int id,
		boolean value
	)
	{
	...
	public EntityMetadata putString(
		int id,
		String value
	)
	{
