...
public class Server
{
	...
	)
	{
		...
		log.info("Loading carrot configuration...");
	...
	public void broadcastPacketsCallback(
		byte[] data,
	...
	public void removePlayerListData(
		UUID uuid,
		Player[] players
	)
	{
	...
	)
	{
		...
		for (Level level : this.getLevels().values())
		{
			...
			{
				log.error(this.getLanguage().translateString(
