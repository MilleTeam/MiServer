...
public abstract class HugeTreesGenerator extends TreeGenerator
{
	...
	public HugeTreesGenerator(
		int baseHeightIn,
		int extraRandomHeightIn,
		Block woodMetadataIn,
		Block leavesMetadataIn
	)
	{
	 ...
	 */
	private boolean isSpaceAt(
		ChunkManager worldIn,
		Vector3 leavesPos,
		int height
	)
	{
	...
	/**
	 * returns whether or not there is dirt underneath the block where the tree will be grown. It also generates dirt around the block in a 2x2 square if there is dirt underneath the blockpos.
	 */
	private boolean ensureDirtsUnderneath(
		Vector3 pos,
		ChunkManager worldIn
	)
	{
	...
	/**
	 * returns whether or not a tree can grow at a specific position. If it can, it generates surrounding dirt underneath.
	 */
	protected boolean ensureGrowable(
		ChunkManager worldIn,
		NukkitRandom rand,
		Vector3 treePos,
		int p_175929_4_
	 ...
	 */
	protected void growLeavesLayerStrict(
		ChunkManager worldIn,
		Vector3 layerCenter,
		int width
	)
	 ...
	 */
	protected void growLeavesLayer(
		ChunkManager worldIn,
		Vector3 layerCenter,
		int width
	)
