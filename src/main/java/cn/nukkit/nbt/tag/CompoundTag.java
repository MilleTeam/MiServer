...
public class CompoundTag extends Tag implements Cloneable
{
	...
	public CompoundTag putByteArray(
		String name,
		byte[] value
	)
	{
	...
	public CompoundTag putIntArray(
		String name,
		int[] value
	)
	{
	...
	public CompoundTag putCompound(
		String name,
		CompoundTag value
	)
	{
	...
	@SuppressWarnings ("unchecked")
	public <T extends Tag> ListTag<T> getList(
		String name,
		Class<T> type
	)
	{
