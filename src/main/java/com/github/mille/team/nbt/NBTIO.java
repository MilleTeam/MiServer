package com.github.mille.team.nbt;
...
public class NBTIO {
    ...
    public static CompoundTag putItemHelper(
        Item item,
        Integer slot
    ) {
    ...
    public static CompoundTag read(
        File file,
    ...
    public static CompoundTag readCompressed(
        InputStream inputStream,
        ByteOrder endianness
    ) throws IOException {
    ...
    public static CompoundTag readNetworkCompressed(
        InputStream inputStream,
        ByteOrder endianness
    ) throws IOException {
        return read(new BufferedInputStream(new GZIPInputStream(inputStream)), endianness);
    ...
    public static byte[] writeGZIPCompressed(
        CompoundTag tag,
        ByteOrder endianness
    ) throws IOException {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
    ...
    public static void writeGZIPCompressed(
        CompoundTag tag,
        OutputStream outputStream
    ) throws IOException {
    ...
    public static byte[] writeNetworkGZIPCompressed(
        CompoundTag tag,
        ByteOrder endianness
    ) throws IOException {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
    ...
    public static void writeNetworkGZIPCompressed(
        CompoundTag tag,
        OutputStream outputStream
    ) throws IOException {
    ...
    public static void writeZLIBCompressed(
        CompoundTag tag,
        OutputStream outputStream
    ) throws IOException {
