package com.github.mille.team.math;
...
public class AxisAlignedBB implements Cloneable {
    ...
    public AxisAlignedBB setBounds(
        double minX,
        double minY,
        double minZ,
        double maxX,
