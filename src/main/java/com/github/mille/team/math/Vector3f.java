...
public class Vector3f implements Cloneable {
     ...
     */
    public Vector3f getIntermediateWithXValue(
        Vector3f v,
        float x
    ) {
     ...
     */
    public Vector3f getIntermediateWithYValue(
        Vector3f v,
        float y
    ) {
        float xDiff = v.x - this.x;
     ...
     */
    public Vector3f getIntermediateWithZValue(
        Vector3f v,
        float z
    ) {
        float xDiff = v.x - this.x;
