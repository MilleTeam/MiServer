...
import static com.github.mille.team.math.BlockFace.*;
import static com.github.mille.team.utils.Rail.Orientation.State.*;
 ...
 */
@API(
    usage = API.Usage.BLEEDING,
    definition = API.Definition.INTERNAL
)
public final class Rail {
    ...
    public enum Orientation {
        ...
        public static Orientation curved(
            BlockFace f1,
            BlockFace f2
        ) {
        ...
        public static Orientation straightOrCurved(
            BlockFace f1,
            BlockFace f2
        ) {
