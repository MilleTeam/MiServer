...
public enum TextFormat {
     ...
     * @return Associative {@link TextFormat} with the given code, or null if it doesn't exist
     */
    ...
    /**
     * Translates a string using an alternate format code character into a string that uses the internal TextFormat.ESCAPE format code character. The alternate format code character will only be replaced if it is immediately followed by 0-9, A-F, a-f, K-O, k-o, R or r.
     *
    ...
    /**
     * Translates a string, using an ampersand (&) as an alternate format code character, into a string that uses the internal TextFormat.ESCAPE format code character. The alternate format code character will only be replaced if it is immediately followed by 0-9, A-F, a-f, K-O, k-o, R or r.
     *
     * @param textToTranslate Text containing the alternate format code character.
     * @return Text containing the TextFormat.ESCAPE format code character.
     */
