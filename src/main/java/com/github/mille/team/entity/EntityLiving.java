...
import com.github.mille.team.entity.data.ShortEntityData;
import com.github.mille.team.entity.item.EntityVehicle;
import com.github.mille.team.entity.passive.EntityWaterAnimal;
...
import com.github.mille.team.network.protocol.EntityEventPacket;
import com.github.mille.team.potion.Effect;
import com.github.mille.team.utils.BlockIterator;
...
public abstract class EntityLiving extends Entity implements EntityDamageable {
    ...
    public void kill() {
        ...
        if (this.level.getGameRules().getBoolean("doEntityDrops")) {
            for (com.github.mille.team.item.Item item : ev.getDrops()) {
