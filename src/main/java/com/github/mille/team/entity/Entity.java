...
import com.github.mille.team.block.BlockWater;
...
import com.github.mille.team.event.entity.EntityPortalEnterEvent.PortalType;
...
import com.github.mille.team.event.player.PlayerTeleportEvent;
import com.github.mille.team.item.Item;
import com.github.mille.team.item.ItemIds;
...
public abstract class Entity extends Location implements Metadatable {
    ...
    public static boolean registerEntity(
        String name,
    ...
    protected void updateRiderPosition(float offset) {
        ...
        if (updateRidden()) {
            linkedEntity.setDataProperty(new Vector3fEntityData(
    ...
    public boolean setPositionAndRotation(
        Vector3 pos,
        double yaw,
        double pitch
    ) {
