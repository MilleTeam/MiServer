...
/**
 * 表达一个容器的接口。<br> An interface describes a container.
 * <p>
...
public interface BlockEntityContainer {
    ...
    /**
     * 返回一个存储在容器里的物品的{@code Item}对象。<br> Returns an item that stores in this container, as an {@code Item} object.
     *
    ...
    /**
     * 把一个物品存储进容器。<br> Sets or stores this item into this container.
     * <p>
    ...
    /**
     * 返回这个容器最多能包含的物品数量。<br> Returns the max number of items that this container can contain.
     *
