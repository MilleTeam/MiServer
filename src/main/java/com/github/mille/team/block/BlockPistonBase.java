...
import com.github.mille.team.level.sound.PistonInSound;
import com.github.mille.team.level.sound.PistonOutSound;
...
public abstract class BlockPistonBase extends BlockSolid {
    ...
    public class BlocksCalculator {
        ...
        private void reorderListAtCollision(
            int count,
            int index
        ) {
