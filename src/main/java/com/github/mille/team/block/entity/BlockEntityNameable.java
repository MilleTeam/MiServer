...
/**
 * 表达一个能被命名的事物的接口。<br> An interface describes an object that can be named.
 *
...
public interface BlockEntityNameable {
    ...
    /**
     * 返回这个事物的名字。<br> Gets the name of this object.
     *
    ...
    /**
     * 设置或更改这个事物的名字。<br> Changes the name of this object, or names it.
     *
    ...
    /**
     * 返回这个事物是否有名字。<br> Whether this object has a name.
     *
