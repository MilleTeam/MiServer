...
public abstract class NukkitRunnable implements Runnable {
    ...
    public synchronized Runnable runTaskLater(
        Plugin plugin,
        int delay
    ...
    public synchronized Runnable runTaskLaterAsynchronously(
        Plugin plugin,
        int delay
    ) throws IllegalArgumentException, IllegalStateException {
        checkState();
    ...
    public synchronized Runnable runTaskTimer(
        Plugin plugin,
        int delay,
        int period
    ) throws IllegalArgumentException, IllegalStateException {
    ...
    public synchronized Runnable runTaskTimerAsynchronously(
        Plugin plugin,
        int delay,
        int period
    ) throws IllegalArgumentException, IllegalStateException {
