...
public class ServerScheduler {
    ...
    public TaskHandler scheduleTask(
        Plugin plugin,
        Runnable task
    ) {
    ...
    public TaskHandler scheduleAsyncTask(
        Plugin plugin,
        AsyncTask task
    ) {
    ...
    @Deprecated
    public void scheduleAsyncTaskToWorker(
        AsyncTask task,
        int worker
    ) {
    ...
    public TaskHandler scheduleDelayedTask(
        Task task,
        int delay
    ) {
