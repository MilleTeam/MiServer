...
import com.github.mille.team.utils.ServerKiller;
...
public class Nukkit {
    ...
    public final static String MI_SERVER_VERSION = "1.0.0";

    public final static String CODENAME = "Minty";

    public final static String NAME = "MiServer";
