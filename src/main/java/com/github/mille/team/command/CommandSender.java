...
public interface CommandSender extends Permissible {
     ...
     * @see com.github.mille.team.utils.TextFormat
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
     ...
     * 如果命令发送者是控制台，将会返回{@code "CONSOLE"}。<br> If this command sender is a player, will return his/her player name(not display name). If it is a console, will return {@code "CONSOLE"}.</p>
     * <p>当你需要判断命令的执行者是不是控制台时，可以用这个：<br>
     * When you need to determine if the sender is a console, use this:<br> {@code if(sender instanceof ConsoleCommandSender) .....;}</p>
     *
     * @return 命令发送者的名称。<br>the name of the command sender.
     * @see Player#getName()
     * @see com.github.mille.team.command.ConsoleCommandSender#getName()
