...
import com.github.mille.team.command.defaults.*;
import com.github.mille.team.command.simple.Arguments;
import com.github.mille.team.command.simple.CommandPermission;
import com.github.mille.team.command.simple.ForbidConsole;
import com.github.mille.team.command.simple.SimpleCommand;
...
public class SimpleCommandMap implements CommandMap {
    ...
    public void registerSimpleCommands(Object object) {
        for (Method method : object.getClass().getDeclaredMethods()) {
            com.github.mille.team.command.simple.Command def = method.getAnnotation(com.github.mille.team.command.simple.Command.class);
            if (def != null) {
