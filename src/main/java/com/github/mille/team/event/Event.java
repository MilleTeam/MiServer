...
/**
 * 描述服务器中可能发生的事情的类。<br> Describes things that happens in the server.
 * <p>
 * <p>服务器中可能发生的事情称作<b>事件</b>。定义一个需要它在一个事件发生时被运行的过程，这个过程称作<b>监听器</b>。<br>
 * Things that happens in the server is called a <b>event</b>. Define a procedure that should be executed when a event happens, this procedure is called a <b>listener</b>.</p>
 * <p>
 ...
 * For the way to implement a listener, see: {@link com.github.mille.team.event.Listener}</p>
 *
