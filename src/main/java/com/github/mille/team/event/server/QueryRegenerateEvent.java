...
import com.github.mille.team.plugin.PluginDescription;
...
public class QueryRegenerateEvent extends ServerEvent {
    ...
    public QueryRegenerateEvent(
        ...
        this.plugins = server.getPluginManager().getPlugins().values().toArray(new Plugin[server.getPluginManager().getPlugins().size()]);
