...
import com.github.mille.team.entity.item.EntityXPOrb;
import com.github.mille.team.entity.projectile.EntityArrow;
import com.github.mille.team.entity.weather.EntityLightning;
import com.github.mille.team.event.block.BlockBreakEvent;
import com.github.mille.team.event.block.BlockPlaceEvent;
import com.github.mille.team.event.block.BlockUpdateEvent;
import com.github.mille.team.event.level.*;
import com.github.mille.team.event.player.PlayerInteractEvent;
import com.github.mille.team.event.player.PlayerInteractEvent.Action;
import com.github.mille.team.event.weather.LightningStrikeEvent;
...
import com.github.mille.team.level.format.Chunk;
import com.github.mille.team.level.format.ChunkSection;
...
import com.github.mille.team.level.format.generic.BaseLevelProvider;
import com.github.mille.team.level.format.generic.EmptyChunkSection;
...
import com.github.mille.team.level.generator.task.*;
import com.github.mille.team.level.particle.DestroyBlockParticle;
import com.github.mille.team.level.particle.Particle;
import com.github.mille.team.level.sound.BlockPlaceSound;
import com.github.mille.team.level.sound.Sound;
import com.github.mille.team.math.*;
import com.github.mille.team.math.BlockFace.Plane;
import com.github.mille.team.metadata.BlockMetadataStore;
import com.github.mille.team.metadata.MetadataValue;
import com.github.mille.team.metadata.Metadatable;
...
public class Level implements ChunkManager, Metadatable {
    ...
    private final Map<Long, List<DataPacket>> chunkPackets = new HashMap<>();
    private final String folderName;
    // Avoid OOM, gc'd references result in whole chunk being sent (possibly higher cpu)
    private final Map<Long, SoftReference<Map<Short, Object>>> changedBlocks = new HashMap<>();
