...
import com.github.mille.team.level.format.anvil.ChunkSection;
...
public class ChunkConverter {
    ...
    public ChunkConverter from(BaseFullChunk chunk) {
        if (!(chunk instanceof com.github.mille.team.level.format.mcregion.Chunk) && !(chunk instanceof com.github.mille.team.level.format.leveldb.Chunk)) {
