package com.github.mille.team.level.format.anvil;
...
import com.github.mille.team.level.format.generic.BaseChunk;
...
public class Chunk extends BaseChunk {
    ...
    public Chunk(
        Class<? extends LevelProvider> providerClass,
        CompoundTag nbt
    ) {
    ...
    public Chunk(
        ...
        com.github.mille.team.level.format.ChunkSection[] sections = new com.github.mille.team.level.format.ChunkSection[16];
        ...
        for (int Y = 0; Y < sections.length; ++Y) {
            com.github.mille.team.level.format.ChunkSection section = sections[Y];
            if (section != null) {
            ...
            for (CompoundTag entryNBT : updateEntries.getAll()) {
                ...
                try {
                    ...
                    if (tag instanceof StringTag) {
                        ...
                        Class<? extends Block> clazz = (Class<? extends Block>) Class.forName("com.github.mille.team.block." + name);
    ...
    public static Chunk fromBinary(
        byte[] data,
    ...
    public static Chunk getEmptyChunk(
        ...
        try {
            ...
            chunk.sections = new com.github.mille.team.level.format.ChunkSection[16];
            for (int y = 0; y < 16; ++y) {
    ...
    public byte[] toFastBinary() {
        ...
        for (com.github.mille.team.level.format.ChunkSection section : this.getSections()) {
