package com.github.mille.team.level.generator.noise;
...
public abstract class Noise {
    ...
    public static double linearLerp(
        double x,
        double x1,
        double x2,
        double q0,
    ...
    public static double bilinearLerp(
        double x,
        double y,
        double q00,
        double q01,
    ...
    abstract public double getNoise2D(
        double x,
        double z
    );

    abstract public double getNoise3D(
        double x,
        double y,
        double z
    );

    public double noise2D(
        double x,
        double z
    ) {
