...
import com.github.mille.team.item.ItemPotion;
import com.github.mille.team.network.protocol.CraftingDataPacket;
...
public class CraftingManager {
    ...
    public CraftingManager() {
        ...
        List<Map> recipes = new Configuration(Server.getInstance().getDataPath() + "recipes.json", Configuration.JSON).getMapList("recipes");
    ...
    public BrewingRecipe matchBrewingRecipe(
        Item input,
        Item potion
    ) {
            ...
            if (r instanceof ShapelessRecipe) {
                ...
                for (Item item : ingredients) {
                    ...
                    for (Item checkItem : checkInput) {
                        if (checkItem.deepEquals(item, checkItem.hasMeta())) {
