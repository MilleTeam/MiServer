...
import com.github.mille.team.event.entity.EntityArmorChangeEvent;
import com.github.mille.team.event.entity.EntityInventoryChangeEvent;
import com.github.mille.team.event.player.PlayerItemHeldEvent;
...
import com.github.mille.team.network.protocol.MobArmorEquipmentPacket;
import com.github.mille.team.network.protocol.MobEquipmentPacket;
import com.github.mille.team.network.protocol.types.ContainerIds;
...
public class PlayerInventory extends BaseInventory {
    ...
    public void setHotbarSlotIndex(
        int index,
        int slot
    ) {
    ...
    //i love java....
    public void setHeldItemIndex(
        int index,
        boolean sendToHolder,
        int slotMapping
    ) {
        if (slotMapping != -1000) {
