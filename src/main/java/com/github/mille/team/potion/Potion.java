package com.github.mille.team.potion;
...
import com.github.mille.team.event.entity.EntityRegainHealthEvent;
import com.github.mille.team.event.potion.PotionApplyEvent;
...
public class Potion implements Cloneable {
    ...
    public static int getApplySeconds(
        int potionType,
        boolean isSplash
    ) {
        if (isSplash) {
